...
const Footer = () => {
  return (
    <div className="bg-[#F2F9EF] md:px-[60px] xl:px-[118px] 3xl:px-[8.1%] mt-8 xl:mt-0 px-6 md:pt-20 md:pb-[49px] py-10 flex flex-col justify-center gap-32 items-center ">
        ...
        <div className="flex flex-row gap-5 w-full lg:justify-between">

{/* Left Section */}
<div className="w-[95%] md:w-[60%] lg:w-[50%] flex md:flex-row flex-wrap lg:flex-nowrap md:justify-between">
...
{/* Right Section */}
<div className="rounded-[16px] bg-[rgb(27,0,41)] px-6 py-8 w-[95%] lg:w-[45%] h-max">
  <p className="text-sm leading-[16px] font-normal font-roobert text-[rgb(255,255,255)]">
  ...
  <div className="mt-5 flex flex-col lg:flex-row gap-5 items-center justify-between">
    ...
    <button className="text-center px-[14px] py-3 bg-[rgb(68,0,102)] flex items-center gap-2 rounded-[96px] text-white font-medium lg:w-max w-full text-sm mt-5 lg:mt-0">
      Subscribe
    </button>
  </div>
</div>
